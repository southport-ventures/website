        ...
        <div>
          <div className="md:grid md:grid-cols-2 md:gap-20">
            <div className="bg-white p-10 shadow-xl">
              <img className="mx-auto mb-5" src={StevePic} alt="Steve Ressler" />
              <h3 className="text-xl lg:text-3xl mb-2 text-center">Steve Ressler</h3>
              <p className="uppercase mb-5 font-bold text-blue-400 text-center">
                Investor & Advisor in SaaS, GovTech, & Search Funds
              </p>
              <p className="mb-5">
                Steve is a serial entrepreneur and CEO and an active investor in search funds. He was the founder and CEO of GovLoop, an online community connecting over 250,000+ government employees, which he successfully sold in 2009.
                He was also the Chief Marketing Officer of Granicus, one of the largest and fastest-growing software platforms serving state and local governments under Vista Equity Partners' ownership.
                He was most recently President of Callyo, a software and technology solutions provider for law enforcement, which he grew and ultimately led the sale of to Motorola Solutions in 2020.
                He is passionate about sharing the lessons and best practices he has learned founding, running and managing small software businesses with entrepreneurs pursuing entrepreneurship through acquisition.
              </p>
            ...
            <div className="bg-white p-10 shadow-xl mb-20 md:mb-0">
              <img className="mx-auto mb-5" src={ScottPic} alt="Scott Stephenson" />
              <h3 className="text-xl lg:text-3xl mb-2 text-center">Scott Stephenson</h3>
              <p className="uppercase mb-5 font-bold text-blue-400 text-center">
                CEO | Verisk
              </p>
              <p className="mb-5">
                ...
                Scott is a values-based leader who launched The Verisk Way—the company’s principles to serve, add value, and innovate that guide how Verisk engages with customers, employees, shareholders, and communities.
                Under his leadership, Verisk has been named one of the World’s Best Employers, one of the World’s Most Innovative Companies, and one of America’s Best Employers for Women.
              </p>
            ...
            <div className="bg-white p-10 shadow-xl mb-20 md:mb-0">
              ...
              <h3 className="text-xl lg:text-3xl mb-2 text-center">Tony Cappaert</h3>
              <p className="uppercase mb-5 font-bold text-blue-400 text-center">
            ...
            <div className="bg-white p-10 shadow-xl mb-20 md:mb-0">
              <img className="mx-auto mb-5" src={ShannonPic} alt="Shannon Jones" />
              <h3 className="text-xl lg:text-3xl mb-2 text-center">Shannon Jones</h3>
              <p className="uppercase mb-5 font-bold text-blue-400 text-center">
                Managing Director | Halstatt Legacy Partners
              </p>
              <p className="mb-5">
                W. Shannon Jones founded Halstatt Legacy Partners to help Halstatt LLC - the investment arm of the Sproul Family - expand its direct private equity investing via Entrepreneurship through Acquisition.
                Halstatt also maintains a portfolio of direct venture capital and private equity investments across many sectors.
                As Managing Director of Halstatt Legacy Partners, Shannon focuses exclusively on forging deep partnerships with a small number of entrepreneurs/operators to find, acquire and grow great companies.
                Shannon currently serves on the boards of Hanlon Acoustical Ceilings, Perfect Surface, RedRock Financial, and Satterfield Paving.
                Prior to Halstatt, Shannon enjoyed extensive experience as a founder and operator of small businesses spanning the software, consumer products, media, and financial services industries.
              </p>
              <a href="https://www.linkedin.com/in/wshannonjones/" target="_blank" rel="noreferrer" className="block">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                  <g fill="#2867B2">
                    <path d="M29.714 0L2.279 0C1.021 0 0 1.036 0 2.307L0 29.693C0 30.964 1.021 32 2.279 32L29.714 32C30.971 32 32 30.964 32 29.693L32 2.307C32 1.036 30.971 0 29.714 0ZM9.671 27.429L4.929 27.429 4.929 12.157 9.679 12.157 9.679 27.429 9.671 27.429ZM7.3 10.071C5.779 10.071 4.55 8.836 4.55 7.321 4.55 5.807 5.779 4.571 7.3 4.571 8.814 4.571 10.05 5.807 10.05 7.321 10.05 8.843 8.821 10.071 7.3 10.071ZM27.45 27.429L22.707 27.429 22.707 20C22.707 18.229 22.671 15.95 20.243 15.95 17.771 15.95 17.393 17.879 17.393 19.871L17.393 27.429 12.65 27.429 12.65 12.157 17.2 12.157 17.2 14.243 17.264 14.243C17.9 13.043 19.45 11.779 21.757 11.779 26.557 11.779 27.45 14.943 27.45 19.057L27.45 27.429Z"/>
                  </g>
            ...
            <div className="bg-white p-10 shadow-xl mb-20 md:mb-0">
              ...
              <h3 className="text-xl lg:text-3xl mb-2 text-center">Mark Thompson</h3>
              <p className="uppercase mb-5 font-bold text-blue-400 text-center">
                CIO | Riverbridge
              </p>
              <p className="mb-5">
                Mark Thompson co-founded Riverbridge in 1987 to pursue his passionate belief in long-term investing.
                As chief manager, Mark is responsible for the strategic decision making and overall management of the firm.
                He is also chairman of the Riverbridge Board of Governors.
                Mark serves as the chief investment officer, where he is responsible for coordinating the efforts of the investment team and overall portfolio compliance to Riverbridge investment disciplines.
              </p>
              <a href="https://www.linkedin.com/in/mark-thompson-b14a657/" target="_blank" rel="noreferrer" className="block">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                  <g fill="#2867B2">
                    <path d="M29.714 0L2.279 0C1.021 0 0 1.036 0 2.307L0 29.693C0 30.964 1.021 32 2.279 32L29.714 32C30.971 32 32 30.964 32 29.693L32 2.307C32 1.036 30.971 0 29.714 0ZM9.671 27.429L4.929 27.429 4.929 12.157 9.679 12.157 9.679 27.429 9.671 27.429ZM7.3 10.071C5.779 10.071 4.55 8.836 4.55 7.321 4.55 5.807 5.779 4.571 7.3 4.571 8.814 4.571 10.05 5.807 10.05 7.321 10.05 8.843 8.821 10.071 7.3 10.071ZM27.45 27.429L22.707 27.429 22.707 20C22.707 18.229 22.671 15.95 20.243 15.95 17.771 15.95 17.393 17.879 17.393 19.871L17.393 27.429 12.65 27.429 12.65 12.157 17.2 12.157 17.2 14.243 17.264 14.243C17.9 13.043 19.45 11.779 21.757 11.779 26.557 11.779 27.45 14.943 27.45 19.057L27.45 27.429Z"/>
                  </g>
            ...
            <div className="bg-white p-10 shadow-xl mb-20 md:mb-0">
              ...
              <h3 className="text-xl lg:text-3xl mb-2 text-center">Andrew Finn</h3>
              <p className="uppercase mb-5 font-bold text-blue-400 text-center">
                Co-founder | G64 Ventures
              </p>
              <p className="mb-5">
                Andrew runs G64 Ventures day-to-day and is the Chairman of CollegePlannerPro and Apartment Guardian, and a Co-Founder of Wait But Why.
              </p>
              <a href="https://www.linkedin.com/in/andrew-finn-0477894/" target="_blank" rel="noreferrer" className="block">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                  <g fill="#2867B2">
                    <path d="M29.714 0L2.279 0C1.021 0 0 1.036 0 2.307L0 29.693C0 30.964 1.021 32 2.279 32L29.714 32C30.971 32 32 30.964 32 29.693L32 2.307C32 1.036 30.971 0 29.714 0ZM9.671 27.429L4.929 27.429 4.929 12.157 9.679 12.157 9.679 27.429 9.671 27.429ZM7.3 10.071C5.779 10.071 4.55 8.836 4.55 7.321 4.55 5.807 5.779 4.571 7.3 4.571 8.814 4.571 10.05 5.807 10.05 7.321 10.05 8.843 8.821 10.071 7.3 10.071ZM27.45 27.429L22.707 27.429 22.707 20C22.707 18.229 22.671 15.95 20.243 15.95 17.771 15.95 17.393 17.879 17.393 19.871L17.393 27.429 12.65 27.429 12.65 12.157 17.2 12.157 17.2 14.243 17.264 14.243C17.9 13.043 19.45 11.779 21.757 11.779 26.557 11.779 27.45 14.943 27.45 19.057L27.45 27.429Z"/>
                  </g>
            ...
            <div className="bg-white p-10 shadow-xl mb-20 md:mb-0">
              ...
              <h3 className="text-xl lg:text-3xl mb-2 text-center">Matt Bennett</h3>
              <p className="uppercase mb-5 font-bold text-blue-400 text-center">
